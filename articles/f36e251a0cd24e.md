...
[^6-84]: [Slides: Deep Dive into firecracker-containerd](https://speakerdeck.com/samuelkarp/deep-dive-into-firecracker-containerd-re-invent-2019-con408)

https://github.com/firecracker-microvm/firecracker

### Unikraft
![Unikraft](https://unikraft.org/assets/imgs/unikraft.svg)
[Unikraft](https://unikraft.org/)は

https://github.com/unikraft/unikraft

### WasmEdge
![WasmEdge](https://landscape.cncf.io/logos/wasm-edge-runtime.svg)
[WasmEdge](https://wasmedge.org/)は、
CNCFのSandboxプロジェクトに認証されている
